...
//это сработает, если у прототипа obj существует constructor, в ином случае по цепочке прототипов дойдет до Object.prototype, который независимо от аргументов создаст пустой объект